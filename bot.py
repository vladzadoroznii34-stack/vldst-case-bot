...
def open_case(case_id):
    ...
    with psycopg.connect(DATABASE_URL) as conn:
        ...
        with conn.cursor() as cur:
            ...
            price_coins = int(case_row[2] or 0)
...
def admin_create_case():
    ...
    try:
        price_coins = int(
            data.get("price_coins", 0)
        )

        price_stars = int(
            data.get("price_stars", 0)
        )
