...
@app.route(
"/api/cases/"int:case_id" (int:case_id)/open",
methods=["POST"]
)
...
with psycopg.connect(
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            if total_chance > 100.00001:

                conn.rollback()

                return {
                    "error":
                        "drop_chances_over_100"
                }, 400
